(ns spirit.essence.datomic.generate-test
  (:use midje.sweet)
  (:require [spirit.essence.datomic.generate :refer :all]
            [spirit.essence.datomic.base :as base]))

^{:refer spirit.essence.datomic.generate/datomic-attr-property :added "0.1"}
...
^{:refer spirit.essence.datomic.generate/datomic-attr :added "0.1"}
...
^{:refer spirit.essence.datomic.generate/datomic-enum :added "0.1"}
...
^{:refer spirit.essence.datomic.generate/datomic :added "0.1"}
(fact "creates a full datomic schema from spirit"
  (->> (datomic {:node/link   [{:ident :node/link
                                :type  :ref
                                :ref {:ns  :node}}]
